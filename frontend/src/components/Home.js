    ...
    <main className="min-h-screen bg-zinc-950 text-white flex flex-col">
      ...
      <div className="flex flex-col items-start justify-center flex-1 max-w-3xl mx-auto w-full px-8 py-20">
        ...
        <h1 className="text-5xl font-semibold text-zinc-100 leading-tight mb-4 tracking-tight">
          Realistic Physique<br />Modeling
        </h1>

        {/* Subtext */}
        <p className="text-zinc-400 text-lg leading-relaxed mb-12 max-w-xl">
          Structural analysis and projected adaptation modeling based on anthropometric inputs, FFMI estimation, and hypertrophy research data.
        </p>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8 w-full max-w-sm relative">
            ...
            <button
              ...
              className="absolute top-4 right-4 text-zinc-600 hover:text-zinc-300 text-sm transition-colors"
            >
              ✕
            </button>
            ...
            <div className="flex bg-zinc-800 border border-zinc-700 rounded-lg p-1 mb-6">
              <button
                ...
                className={`flex-1 py-2 rounded-md text-xs font-medium uppercase tracking-wide transition-all ${
                  isLogin ? "bg-emerald-600 text-white" : "text-zinc-500 hover:text-zinc-300"
                }`}
              >
                Sign In
              </button>
